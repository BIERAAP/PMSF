...
function gymLabel(item) {
    ...
    if (teamId === 0) {
        str =
            ...
            '</div>' +
            '<div>' +
            i8ln('Navigate to') + ': <a href="javascript:void(0);" onclick="javascript:openMapDirections(' + latitude + ',' + longitude + ');" title="' + i8ln('View in Maps') + '">' + latitude.toFixed(6) + ' , ' + longitude.toFixed(7) + '</a>' +
            '</div>' +
            '<div>' +
        ...
        if (((!noWhatsappLink) && (raidSpawned && item.raid_end > Date.now())) && (item.raid_pokemon_id > 1 && item.raid_pokemon_id < numberOfPokemon)) {
            ...
            str += '<center>' +
                '<div>' +
                '<a href="whatsapp://send?text=%2A' + encodeURIComponent(item.name) + ' Level ' + item.raid_level + ' Hatch : ' + raidStartStr + ' Raid: ' + raidEndStr + '%2A' +'" data-action="share/whatsapp/share">Whatsapp Link</a>' +'</div>' +
                '</center>'
        }
    } else {
        ...
        str =
            ...
            '</div>' +
            '<div>' +
            '<a href="javascript:void(0);" onclick="javascript:openMapDirections(' + latitude + ',' + longitude + ');" title="' + i8ln('View in Maps') + '">Navigate to</a>' +
            '</div>' +
            '<div>' +
...
function nestLabel(item) {
    ...
    str += '<div>' +
        '<a href="javascript:void(0)" onclick="javascript:openMapDirections(' + item.lat + ',' + item.lon + ')" title="' + i8ln('View in Maps') + '"> Navigate to </a>' +
        '</div>'
...
function showGymDetails(id) { // eslint-disable-line no-unused-vars
    ...
    data.done(function (result) {
        ...
        var headerHtml =
            ...
            lastScannedStr +
            '<div>' +
            '<a href=\'javascript:void(0)\' onclick=\'javascript:openMapDirections(' + result.latitude + ',' + result.longitude + ')\' title=\'' + i8ln('View in Maps') + '\'>' + i8ln('Get directions') +
            '</div>' +
            '</center>'
